...
export function SelectAreaUnit(props: FullSelectAssetsItemProps) {
  const theme = useTheme();
    return (
      <Select value={props.selectedAssetstype} onValueChange={props.setSelectedAssetsType} disablePreventBodyScroll {...props}>
        <Select.Trigger width={width - 1000} height={36} minWidth={70} minHeight={20} paddingVertical={5} paddingHorizontal={10}>
          <Select.Value placeholder="Select units" fontSize={FontSizes.size18}/>
        </Select.Trigger>
